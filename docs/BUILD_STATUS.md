...
- Structured product catalog covering Uretherm, ChemNate, KlayOl polyols, the controlled PPG naming set, flexible systems, additives and UreShield.
...
## Equal-priority integration completed in PR #3
...
1. Confirm the public KlayOl PPG grade numbering. One approved project source lists `PPG 1420 / 1440 / 1410 / 1404 / 1412`, while another supplied brochure lists `PPG 2420 / 2440 / 2410 / 2404 / 2412`. The public site continues to treat the grade set as controlled until confirmed.
...
3. Confirm the official public Urechem naming map for the neutral injection-grouting reference codes. The technical application data is published with explicit validation boundaries, but unapproved source brand names are not exposed.

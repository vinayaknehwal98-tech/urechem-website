...
export function HeroSection() {
  ...
  return (
    <section className="minimal-hero relative isolate -mt-16 overflow-hidden border-b border-blue-100 bg-slate-100 pt-16 md:-mt-[4.5rem] md:min-h-screen md:pt-[4.5rem]">
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-30 overflow-hidden bg-slate-100 bg-cover bg-[70%_center] md:bg-[center_72%]"
        style={{ backgroundImage: `url(${HERO_POSTER})` }}
      >
        <video
          className={`h-full w-full object-cover object-[70%_center] [backface-visibility:hidden] [transform:translateZ(0)] transition-opacity duration-700 ease-out md:object-[center_72%] ${
      ...
      <Container className="flex min-h-[38rem] items-center py-16 sm:min-h-[42rem] md:min-h-screen md:py-24 md:pt-36">

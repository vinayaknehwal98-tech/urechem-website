    ...
    >
      <div className="grid auto-rows-fr gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {applicationCategories.map((application, index) => (
          <Link
            className="group relative flex min-h-80 flex-col overflow-hidden rounded-[var(--radius-lg)] border border-white/10 bg-white/[0.045] p-5 pb-16 shadow-[var(--shadow-soft)] transition duration-300 hover:-translate-y-1 hover:border-cyan-200/34 hover:bg-cyan-300/[0.07] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-200"

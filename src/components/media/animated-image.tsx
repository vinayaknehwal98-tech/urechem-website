...
export function AnimatedImage({
  ...
  return (
    <motion.figure
      ...
      ref={ref}
      transition={{
        opacity: { duration: 0.7, ease: revealEase, times: [0, 1] },
        x: { duration: 0.98, ease: revealEase, times: [0, 1] },
        y: { duration: 0.98, ease: revealEase, times: [0, 1] },
        scale: { duration: 0.98, ease: revealEase, times: [0, 1] },
        filter: { duration: 0.4, ease: "easeOut", times: [0, 0.72, 1] },
      }}
    ...
    >
      ...
      <motion.div
        ...
        initial={false}
        transition={{ delay: 0.06, duration: 0.94, ease: revealEase }}
      />
      ...
      <motion.div
        ...
        initial={false}
        transition={{ delay: 0.18, duration: 0.86, ease: "easeInOut" }}
      />
    </motion.figure>
  );
}

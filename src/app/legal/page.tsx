  ...
  return (
    <Container className="py-16 sm:py-20">
      ...
      <div className="mt-5 max-w-4xl">
        <h1 className="text-4xl font-black tracking-[-0.04em] text-slate-900 sm:text-5xl">Legal notice</h1>
        <p className="mt-4 text-sm font-semibold uppercase tracking-[0.14em] text-sky-700">
      ...
      <div className="mt-10 max-w-4xl space-y-10 text-base leading-8 text-slate-600">
        <section>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">1. Website operator and business information</h2>
          <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <dl>
              {businessDetails.map(([label, value]) => (
                <div
                  key={label}
                  className="grid gap-1 border-b border-slate-100 px-5 py-4 last:border-b-0 sm:grid-cols-[13rem_1fr] sm:gap-6 sm:px-6"
                >
          ...
          <p className="mt-5 text-slate-600">
            ...
            <Link className="font-semibold text-sky-700 underline decoration-sky-200 underline-offset-4 hover:text-sky-800" href="/contact">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">2. Copyright</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">3. Trademarks and product names</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">4. Product-safety notice</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">5. Technical-information notice</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">6. AI and automated-content notice</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">7. Quotations, orders and official communications</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">8. Accuracy and changes</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">9. External links and third-party content</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900">10. Reporting errors, infringement or security concerns</h2>
          <p className="mt-3">
        ...
        <section className="border-t border-slate-200 pt-8">
          <h2 className="text-2xl font-semibold text-slate-900">Related policies</h2>
          <p className="mt-3">
            Use of this website is also governed by the{" "}
            <Link className="font-semibold text-sky-700 underline decoration-sky-200 underline-offset-4 hover:text-sky-800" href="/terms">
              Terms of Use
            </Link>{" "}
            and the{" "}
            <Link className="font-semibold text-sky-700 underline decoration-sky-200 underline-offset-4 hover:text-sky-800" href="/privacy">
              Privacy Policy
            </Link>
            .
          </p>

    ...
    <>
      <section className="relative isolate flex min-h-[calc(100svh-5rem)] items-center overflow-hidden border-b border-blue-100 py-16 sm:py-20 lg:py-24">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg,rgba(248,251,255,0.98) 0%,rgba(248,251,255,0.93) 38%,rgba(239,246,255,0.74) 62%,rgba(3,20,38,0.35) 82%,rgba(3,20,38,0.52) 100%)",
          }}
        />
        <div
          aria-hidden="true"
          ...
          style={{
            background:
              "radial-gradient(circle at 78% 32%,rgba(14,165,233,0.18),transparent 27rem),radial-gradient(circle at 17% 86%,rgba(37,99,235,0.11),transparent 25rem)",
          }}
        />
        ...
        <Container className="relative w-full">
          <div className="max-w-4xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ButtonLink href={`/contact?type=Consultation%20request&product=${encodeURIComponent(productFamily.name)}`}>

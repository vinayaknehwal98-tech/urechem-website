...
export const metadata = { title: "AI Solution Finder | Urechem Chemicals" };

export default function Page() {
  return (
    <Container className="py-16">
      <h1 className="text-4xl font-semibold">AI solution finder</h1>
      <p className="mt-4 max-w-3xl text-slate-300">Structure your application, material and performance challenge into a technical enquiry for Urechem review.</p>

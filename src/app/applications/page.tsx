...
export default function Page() {
  return (
    <Container className="py-16 sm:py-20">
      ...
      <AnimatedImage
        alt="Construction crew applying and finishing concrete at an active site"
        className="mt-10 h-72 sm:h-80"
        imageClassName="object-center"
        sizes="100vw"
        src="https://images.unsplash.com/photo-1673978484091-6a743a9058cf?auto=format&fit=crop&fm=jpg&q=82&w=1900"
      />

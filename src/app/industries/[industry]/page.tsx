    ...
    <main className="industry-page bg-white">
      ...
      <section className="border-b border-slate-200 py-16 sm:py-20">
        <Container><div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <figure className="group relative overflow-hidden rounded-2xl border border-slate-200 shadow-[0_24px_70px_rgba(15,23,42,0.16)]"><img alt={detail.imageAlt} className="h-[30rem] w-full object-cover transition duration-700 group-hover:scale-105" loading="lazy" src={detail.image} /><figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-950/90 to-transparent p-6 pt-32"><p className="text-xs font-black uppercase tracking-[0.2em] text-cyan-300 drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)]">Project context matters</p><p className="industry-image-caption mt-3 max-w-xl rounded-lg border border-white/10 bg-slate-950/75 px-4 py-3 text-sm font-semibold leading-6 !text-white shadow-lg backdrop-blur-sm">{detail.imageCaption}</p></figcaption></figure>
        </div></Container>
      </section>
